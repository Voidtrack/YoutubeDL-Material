...
export class PostsService {
  ...
  constructor(
    ...
    if (isDevMode()) {
      this.debugMode = true;
      this.path = !environment.codespaces
        ? "http://localhost:17442/api/"
        : `${window.location.origin.replace("4200", "17442")}/api/`;
    }
    ...
    if (localStorage.getItem("sidepanel_mode") as MatDrawerMode) {
      this.sidepanel_mode = localStorage.getItem(
        "sidepanel_mode"
      ) as MatDrawerMode;
    }
  ...
  generateArgs(
    ...
    return this.http.post<GenerateArgsResponse>(
      this.path + "generateArgs",
      body,
      this.httpOptions
    );
  }
  ...
  getDBInfo() {
    return this.http.get<DBInfoResponse>(
      this.path + "getDBInfo",
      this.httpOptions
    );
  }
  ...
  transferDB(local_to_remote) {
    ...
    return this.http.post<TransferDBResponse>(
      this.path + "transferDB",
      body,
      this.httpOptions
    );
  }
  ...
  testConnectionString(connection_string: string) {
    const body: TestConnectionStringRequest = {
      connection_string: connection_string,
    };
    return this.http.post<TestConnectionStringResponse>(
      this.path + "testConnectionString",
      body,
      this.httpOptions
    );
  }
  ...
  killAllDownloads() {
    return this.http.post<SuccessObject>(
      this.path + "killAllDownloads",
      {},
      this.httpOptions
    );
  }
  ...
  deleteFile(uid: string, blacklistMode = false) {
    const body: DeleteMp3Mp4Request = {
      uid: uid,
  ...
  getMp3s() {
    return this.http.get<GetMp3sResponse>(
      this.path + "getMp3s",
      this.httpOptions
    );
  }
  ...
  getMp4s() {
    return this.http.get<GetMp4sResponse>(
      this.path + "getMp4s",
      this.httpOptions
    );
  }
  ...
  getAllFiles(
    ...
    file_type_filter: FileTypeFilter = FileTypeFilter.BOTH,
    ...
    return this.http.post<GetAllFilesResponse>(
      this.path + "getAllFiles",
      body,
      this.httpOptions
    );
  }

  updateFile(uid: string, change_obj: Record<string, unknown>) {
    const body: UpdateFileRequest = { uid: uid, change_obj: change_obj };
    return this.http.post<SuccessObject>(
      this.path + "updateFile",
      body,
      this.httpOptions
    );
  }
  ...
  downloadFileFromServer(uid: string, uuid: string = null) {
    ...
    return this.http.post(this.path + "downloadFileFromServer", body, {
      responseType: "blob",
  ...
  getFullTwitchChat(id, type, uuid = null, sub = null) {
    const body: GetFullTwitchChatRequest = {
      id: id,
      type: type,
      uuid: uuid,
      sub: sub,
    };
    return this.http.post<GetFullTwitchChatResponse>(
      this.path + "getFullTwitchChat",
      body,
      this.httpOptions
    );
  }
  ...
  downloadTwitchChat(id, type, vodId, uuid = null, sub = null) {
    const body: DownloadTwitchChatByVODIDRequest = {
      id: id,
      type: type,
      vodId: vodId,
      uuid: uuid,
    ...
    return this.http.post<DownloadTwitchChatByVODIDResponse>(
      this.path + "downloadTwitchChatByVODID",
      body,
      this.httpOptions
    );
  }
  ...
  checkConcurrentStream(uid) {
    ...
    return this.http.post<CheckConcurrentStreamResponse>(
      this.path + "checkConcurrentStream",
      body,
      this.httpOptions
    );
  }
  ...
  updateConcurrentStream(uid, playback_timestamp, unix_timestamp, playing) {
    const body: UpdateConcurrentStreamRequest = {
      uid: uid,
      playback_timestamp: playback_timestamp,
      unix_timestamp: unix_timestamp,
      playing: playing,
    };
    return this.http.post<UpdateConcurrentStreamResponse>(
      this.path + "updateConcurrentStream",
      body,
      this.httpOptions
    );
  }
  ...
  downloadArchive(type: FileType, sub_id: string) {
    ...
    return this.http.post(this.path + "downloadArchive", body, {
      responseType: "blob",
      params: this.httpOptions.params,
    });
  }
  ...
  getArchives(type: FileType = null, sub_id: string = null) {
    ...
    return this.http.post<GetArchivesResponse>(
      this.path + "getArchives",
      body,
      this.httpOptions
    );
  }
  ...
  importArchive(archive_base64: string, type: FileType, sub_id: string = null) {
    const body: ImportArchiveRequest = {
      archive: archive_base64,
      type: type,
      sub_id: sub_id,
    };
    return this.http.post<SuccessObject>(
      this.path + "importArchive",
      body,
      this.httpOptions
    );
  }
  ...
  getFileFormats(url: string) {
    ...
    return this.http.post<GetFileFormatsResponse>(
      this.path + "getFileFormats",
      body,
      this.httpOptions
    );
  }
  ...
  getLogs(lines = 50) {
    ...
    return this.http.post<GetLogsResponse>(
      this.path + "logs",
      body,
      this.httpOptions
    );
  ...
  generateNewAPIKey() {
    return this.http.post<GenerateNewApiKeyResponse>(
      this.path + "generateNewAPIKey",
      {},
      this.httpOptions
    );
  }
  ...
  getPlaylist(
    ...
    return this.http.post<GetPlaylistResponse>(
      this.path + "getPlaylist",
      body,
      this.httpOptions
    );
  }
  ...
  getPlaylists(include_categories = false) {
    return this.http.post<GetPlaylistsRequest>(
      this.path + "getPlaylists",
  ...
  incrementViewCount(file_uid, sub_id, uuid) {
    const body: IncrementViewCountRequest = {
      file_uid: file_uid,
      sub_id: sub_id,
      uuid: uuid,
    };
    return this.http.post<SuccessObject>(
      this.path + "incrementViewCount",
      body,
      this.httpOptions
    );
  }
  ...
  addFileToPlaylist(playlist_id, file_uid) {
    const body: AddFileToPlaylistRequest = {
      playlist_id: playlist_id,
      file_uid: file_uid,
    };
    return this.http.post<SuccessObject>(
      this.path + "addFileToPlaylist",
      body,
      this.httpOptions
    );
  }
  ...
  cancelCheckSubscription(sub_id: string) {
    const body: CheckSubscriptionRequest = { sub_id: sub_id };
    return this.http.post<SuccessObject>(
      this.path + "cancelCheckSubscription",
      body,
      this.httpOptions
    );
  }
  ...
  unsubscribe(sub_id: string, deleteMode = false) {
    ...
    return this.http.post<UnsubscribeResponse>(
  ...
  deleteSubscriptionFile(file_uid: string, deleteForever: boolean) {
    const body: DeleteSubscriptionFileRequest = {
      file_uid: file_uid,
      deleteForever: deleteForever,
    };
    return this.http.post<SuccessObject>(
      this.path + "deleteSubscriptionFile",
      body,
      this.httpOptions
    );
  }
  ...
  getSubscription(id: string, name: string = null) {
    ...
    return this.http.post<GetSubscriptionResponse>(
  ...
  getAllSubscriptions() {
    return this.http.post<GetAllSubscriptionsResponse>(
      this.path + "getSubscriptions",
      {},
      this.httpOptions
    );
  }
  ...
  getCurrentDownloads(uids: Array<string> = null) {
    ...
    return this.http.post<GetAllDownloadsResponse>(
      this.path + "downloads",
      body,
      this.httpOptions
    );
  ...
  getCurrentDownload(download_uid: string) {
    ...
    return this.http.post<GetDownloadResponse>(
      this.path + "download",
      body,
      this.httpOptions
    );
  ...
  restartDownload(download_uid: string) {
    const body: GetDownloadRequest = { download_uid: download_uid };
    return this.http.post<RestartDownloadResponse>(
      this.path + "restartDownload",
      body,
      this.httpOptions
    );
  }
  ...
  getTasks() {
    return this.http.post<GetAllTasksResponse>(
      this.path + "getTasks",
      {},
      this.httpOptions
    );
  ...
  getTask(task_key: TaskType) {
    ...
    return this.http.post<GetTaskResponse>(
      this.path + "getTask",
      body,
      this.httpOptions
    );
  ...
  updateTaskSchedule(task_key: TaskType, schedule: Schedule) {
    const body: UpdateTaskScheduleRequest = {
      task_key: task_key,
      new_schedule: schedule,
    };
    return this.http.post<SuccessObject>(
      this.path + "updateTaskSchedule",
      body,
      this.httpOptions
    );
  }
  ...
  updateTaskOptions(task_key: TaskType, options: any) {
    const body: UpdateTaskOptionsRequest = {
      task_key: task_key,
      new_options: options,
    };
    return this.http.post<SuccessObject>(
      this.path + "updateTaskOptions",
      body,
      this.httpOptions
    );
  }
  ...
  getUpdaterStatus() {
    return this.http.get<UpdaterStatus>(
      this.path + "updaterStatus",
      this.httpOptions
    );
  }
  ...
  getLatestGithubRelease() {
    return this.http.get(
      "https://api.github.com/repos/tzahi12345/youtubedl-material/releases/latest"
    );
  }

  getAvailableRelease() {
    return this.http.get(
      "https://api.github.com/repos/tzahi12345/youtubedl-material/releases"
    );
  }
  ...
  hasPermission(permission) {
    ...
    return this.config.Advanced.multi_user_mode
  ...
  register(username: string, password: string) {
    ...
    const call = this.http.post<RegisterResponse>(
  ...
  changeUserPassword(user_uid, new_password) {
    return this.http.post(
      this.path + "auth/changePassword",
      { user_uid: user_uid, new_password: new_password },
      this.httpOptions
    );
  }
  ...
  getRoles() {
    return this.http.post<GetRolesResponse>(
      this.path + "getRoles",
      {},
      this.httpOptions
    );
  ...
  setUserPermission(
    ...
    const body: ChangeUserPermissionsRequest = {
      user_uid: user_uid,
      permission: permission,
      new_value: new_value,
    };
    return this.http.post<SuccessObject>(
      this.path + "changeUserPermissions",
      body,
      this.httpOptions
    );
  }
  ...
  setRolePermission(
    ...
    const body: ChangeRolePermissionsRequest = {
      role: role_name,
      permission: permission,
      new_value: new_value,
    };
    return this.http.post<SuccessObject>(
      this.path + "changeRolePermissions",
      body,
      this.httpOptions
    );
  }
  ...
  getNotifications(): Observable<GetNotificationsResponse> {
    return this.http.post<GetNotificationsResponse>(
  ...
  setNotificationsToRead(uids: string[]): Observable<SuccessObject> {
    ...
    return this.http.post<SuccessObject>(
      this.path + "setNotificationsToRead",
      body,
      this.httpOptions
    );
  }
  ...
  deleteAllNotifications(): Observable<SuccessObject> {
    return this.http.post<SuccessObject>(
      this.path + "deleteAllNotifications",
      {},
      this.httpOptions
    );
  }
